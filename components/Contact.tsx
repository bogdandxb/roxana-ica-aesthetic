        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              <span className="text-[#C6A769] text-sm tracking-widest uppercase" style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 500 }}>Telefon & WhatsApp</span>
              ...
              <a
                ...
                className="btn-gold w-fit flex items-center gap-2 mt-1"
            ...
            <div className="flex flex-col gap-2">
              <span className="text-[#C6A769] text-sm tracking-widest uppercase" style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 500 }}>Locație</span>
              <p className="text-[#7A6F66] text-base" style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 400 }}>
            ...
            <div className="flex flex-col gap-4">
              <span className="text-[#C6A769] text-sm tracking-widest uppercase" style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 500 }}>Social Media</span>
          ...
          <div className="flex flex-col gap-8 justify-center">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[#7A6F66] text-base leading-relaxed" style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 400 }}>
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                <a
                  ...
                  style={{ fontFamily: 'var(--font-montserrat)' }}
                >
                  <span className="text-[#4A403A] group-hover:text-[#C6A769] transition-colors text-sm tracking-wide uppercase" style={{ fontWeight: 500 }}>{item.label}</span>
