...
export default function Footer() {
  return (
    <footer className="bg-[#4A403A] text-[#E8E1D8]">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 py-16 px-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 inline-flex items-center gap-2 border border-[#C6A769] text-[#C6A769] hover:bg-[#C6A769] hover:text-[#4A403A] transition-all px-4 py-2.5 text-[10px] tracking-widest uppercase w-fit"
            style={{ fontFamily: 'var(--font-montserrat)' }}
          >
      ...
      {/* Copyright */}
      <div className="max-w-7xl mx-auto px-6 pb-8 pt-4 border-t border-[#7A6F66]/40 flex justify-between items-center">
